...
namespace Generics
{
    ...
    class Program
    {
        static void Main(string[] args) {
            ...
            Console.WriteLine("There are {0} cars collection.\n", carList.Count);

            // How many Fords are there?
            List<ClassicCar> fordList = carList.FindAll(FindFords);
            Console.WriteLine("There are {0} Fords collection.\n", fordList.Count);
            ...
            Console.WriteLine("Collection contains {0} unique manufacturers.\n", makes.Keys.Count);
